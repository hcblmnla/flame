...
public class FlameCommand implements Callable<Void> {
    ...
    private static void callWithArguments(
        ...
        var image = generator.generate(affine, vs, samples, iterations, symmetries, threads);
    ...
    private static void log(final Writer writer, final String message, final Object... args) throws IOException {
